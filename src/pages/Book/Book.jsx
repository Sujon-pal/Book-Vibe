...
const Book = ({ booksPromise }) => {
  ...
  return (
    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 cursor-pointer">
      {books.map((book) => (
        <Link key={book.bookId} to={`/BookDetails/${book.bookId}`}>
          <div className="p-4 transition duration-300 border border-gray-300 shadow-sm rounded-2xl hover:shadow-lg">
